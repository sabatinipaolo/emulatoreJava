public class Memory {
    ...
    public Memory(Sistema sistema) {
        ...
        mem[0] = new Registro(16);
        mem[1] = new Registro(11);
        mem[2] = new Registro(17);
        mem[3] = new Registro(12);
        mem[4] = new Registro(18);
        mem[5] = new Registro(13);
        mem[6] = new Registro(19);
        mem[7] = new Registro(14);
        mem[8] = new Registro(8);
        mem[9] = new Registro(9);
        mem[10] = new Registro(10);
        mem[11] = new Registro(11);
        mem[12] = new Registro(22);
        mem[13] = new Registro(33);
        mem[14] = new Registro(44);
        mem[15] = new Registro(88);
